...
import static pro.crypto.model.indicator.IndicatorType.CHANDE_MOMENTUM_OSCILLATOR;
...
public class ChandeMomentumOscillator implements Indicator<CMOResult> {
    ...
    private BigDecimal[] calculateSignalLineValues(BigDecimal[] cmoValues) {
        BigDecimal[] movingAverageValues = IndicatorResultExtractor.extractIndicatorValues(calculateMovingAverage(cmoValues));
