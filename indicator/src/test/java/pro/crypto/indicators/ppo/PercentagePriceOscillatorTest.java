...
public class PercentagePriceOscillatorTest {
    ...
    public void testPercentagePriceOscillatorWithRecommendedPeriods() {
        ...
        assertEquals(result[33].getSignalLineResult(), toBigDecimal(-2.7661095387));
        ...
        assertEquals(result[43].getSignalLineResult(), toBigDecimal(1.1186642718));
        ...
        assertEquals(result[49].getSignalLineResult(), toBigDecimal(2.3315850277));
        ...
        assertEquals(result[58].getSignalLineResult(), toBigDecimal(2.5480082842));
        ...
        assertEquals(result[72].getSignalLineResult(), toBigDecimal(1.4764845153));
