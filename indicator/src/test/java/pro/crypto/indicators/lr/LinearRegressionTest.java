package pro.crypto.indicators.lr;
...
import pro.crypto.model.request.LRRequest;
import pro.crypto.model.result.LRResult;
...
public class LinearRegressionTest {
    ...
    private LRRequest buildRequest(boolean averageCalculation) {
