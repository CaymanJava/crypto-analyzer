...
public class RangeOfChangeTest {
    ...
    public void testRangeOfChangeWithPeriodFourteen() {
        ...
        assertEquals(result[13].getIndicatorValue(), new BigDecimal(-3.3825484200).setScale(10, BigDecimal.ROUND_HALF_UP));
        assertEquals(result[19].getTime(), of(2018, 3, 16, 0, 0));
        assertEquals(result[19].getIndicatorValue(), new BigDecimal(-10.9004447100).setScale(10, BigDecimal.ROUND_HALF_UP));
        assertEquals(result[32].getTime(), of(2018, 3, 29, 0, 0));
        assertEquals(result[32].getIndicatorValue(), new BigDecimal(8.5516007200).setScale(10, BigDecimal.ROUND_HALF_UP));
        assertEquals(result[45].getTime(), of(2018, 4, 11, 0, 0));
        assertEquals(result[45].getIndicatorValue(), new BigDecimal(10.1289800300).setScale(10, BigDecimal.ROUND_HALF_UP));
        assertEquals(result[58].getTime(), of(2018, 4, 24, 0, 0));
        assertEquals(result[58].getIndicatorValue(), new BigDecimal(4.8231465400).setScale(10, BigDecimal.ROUND_HALF_UP));
        assertEquals(result[72].getTime(), of(2018, 5, 8, 0, 0));
        assertEquals(result[72].getIndicatorValue(), new BigDecimal(-8.0535237100).setScale(10, BigDecimal.ROUND_HALF_UP));
    }
